...
export function createPersistedLeadSalesIntakeRuntime(pool: Pool) {
  ...
  const governedOutreachHumanExecution = createSalesGovernedOutreachHumanExecutionService(operationalRepository);
