...
const migrationPath = new URL('../infra/supabase/migrations/202608211430_sales_inbound_reply_evidence.sql', import.meta.url);
...
try {
  ...
  console.log('PASS  Sales inbound reply evidence migration applied.');
} catch (error) {
